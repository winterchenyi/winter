					...
					.extend(
							...
							$.messager.defaults,
							{
								content : "<div class=\"messager-icon messager-question\"></div>"
										...
										+ "<br/>"
										+ "<div style=\"clear:both;\"/>"
										+ "<div><select class=\"messager-select\" style=\"width:100%;\"><option value=\"Y\">通过</option><option value=\"N\">不通过</option></select></div>"
							}, opts);
			if (!opts.buttons) {
				opts.buttons = [ {
					text : opts.ok,
					onClick : function() {
						_2ba(dlg, dlg.find(".messager-select").val());
					}
				}, {
					text : opts.cancel,
					onClick : function() {
